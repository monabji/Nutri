...
“A barcode tells us what a product is, but not what happened to it on the way to the shelf. Soil2Fork combines public product facts with a transparent transport scenario so people can see both what is known and what is being modeled.”
...
“Soil2Fork turns an opaque food journey into an explorable decision surface while making the boundary between evidence and estimation visible.”
