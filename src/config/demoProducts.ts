...
export const demoProducts: Record<string, DemoProduct> = {
  '8901719117183': {
    ...
    origins: ['India'], countries: ['India'], manufacturingPlaces: ['Parle Products, 15 km Stone, Tumkur Road, Bengaluru Rural, Karnataka 560073, India'], quantityGrams: 100,
    ...
    demoRoute: { origin: { latitude: 13.0431678, longitude: 77.4867373, label: 'Parle Products, Tumkur Road, Bengaluru Rural' }, destination, path: [[13.0431678, 77.4867373], [12.9818, 79.1368]], distanceKm: 208.1, durationHours: 2.7, weather: { averageTemperatureC: 29, minimumTemperatureC: 27, maximumTemperatureC: 31, sampleCount: 5, observedAt: '2026-09-04T12:00:00Z' }, routingKind: 'driving', originKind: 'researched-source' },
  },
  '8901491100267': {
    ...
    origins: ['India'], countries: ['India'], manufacturingPlaces: ['PepsiCo India Foods Plant, Plot Q1, Kosi Kotwan Industrial Area Extension II, Mathura, Uttar Pradesh 281403, India'], quantityGrams: 100,
    ...
    demoRoute: { origin: { latitude: 27.8014, longitude: 77.5055, label: 'PepsiCo India Foods Plant, Plot Q1, Kosi Kotwan Industrial Area' }, destination, path: [[27.8014, 77.5055], [12.9818, 79.1368]], distanceKm: 2037.5, durationHours: 25.5, weather: { averageTemperatureC: 32, minimumTemperatureC: 29, maximumTemperatureC: 36, sampleCount: 5, observedAt: '2026-09-04T12:00:00Z' }, routingKind: 'driving', originKind: 'manufacturing-place' },
  },
}
