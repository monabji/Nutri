# Soil2Fork Continuous Judge

## Purpose

This file defines an event-driven judging system for Soil2Fork. It is intended to be used by the project lead or an AI coding agent after meaningful changes, before a demo, and during milestone reviews.
...
The judge must continuously evaluate whether Soil2Fork is becoming a stronger response to the brief:
...
Soil2Fork is a food-transparency and supply-chain scenario tool. A user enters a product barcode and explores how temperature, transit time, transport mode, route, and other assumptions affect modeled nutrient availability and environmental impact.
...
Any finding that would cause Soil2Fork to invent data, hide uncertainty, or make an unsupported health claim is a release blocker.
